import{r as n,j as e}from"./index-DJBkvtKB.js";const i=`\r
/* ═══ RESET & ROOT ════════════════════════════════════════════════════════ */\r
...
\r
  /* Logo strip (10+ Industries) */\r
  #strip{padding:2rem 0}\r
  .strip-label{font-size:.82rem;margin-bottom:1.5rem;letter-spacing:.04em}\r
  .logo-chip{font-size:.78rem;padding:.6rem 1rem;gap:.6rem;border-radius:8px}\r
  .logo-chip svg{width:20px;height:20px}\r
  .marq-wrap::before,.marq-wrap::after{width:60px}\r
\r
  /* Engagement deliverable */\r
  .eng-del-txt{font-size:.78rem;line-height:1.5;text-align:center;word-break:break-word}\r
  .eng-deliverable{padding:0 1rem}\r
