import{r as n,j as e}from"./index-C_KNHDNv.js";const i=`\r
/* ═══ RESET & ROOT ════════════════════════════════════════════════════════ */\r
...
\r
  ...
  /* Footer mobile */\r
  .ft-main{flex-direction:column;gap:2rem;padding:2rem 0 1.8rem}\r
  .ft-left{width:100%}\r
  .ft-logo-link{width:200px;height:95px}\r
  .ft-logo-img{width:180px}\r
  .ft-nav{\r
    display:grid;\r
    grid-template-columns:1fr 1fr;\r
    gap:1.8rem 1.2rem;\r
    flex:none;width:100%;\r
    justify-content:flex-start}\r
  .ft-right{align-items:flex-start;width:100%;border-top:1px solid rgba(255,255,255,.1);padding-top:1.2rem}\r
  .ft-bar{flex-direction:column;align-items:flex-start;gap:.5rem}\r
}\r
@media(max-width:768px){\r
  .container{padding:0 20px}\r
\r
  /* ── Nav ── */\r
...
\r
  ...
  .sec-hd p{font-size:.88rem}\r
  .section-label{font-size:.72rem}\r
\r
  /* ── Hero ── */\r
  .hero-reel{min-height:100svh}\r
  .reel-slide{align-items:flex-start;padding-top:120px}\r
  .reel-inner{text-align:center;max-width:100%;padding:0 1.5rem}\r
  .reel-eyebrow{font-size:clamp(.88rem,4vw,1.3rem);white-space:normal;letter-spacing:.05em;justify-content:center;width:100%}\r
  .reel-slide[data-idx="2"] .reel-eyebrow,\r
  .reel-slide[data-idx="3"] .reel-eyebrow{font-size:clamp(.72rem,3.2vw,1rem)}\r
  .reel-slide h1{font-size:clamp(1.3rem,5.5vw,2rem);text-align:center}\r
  .reel-slide[data-idx="0"] h1{font-size:clamp(1.2rem,5.2vw,1.8rem)}\r
  .reel-nowrap{white-space:normal}\r
  .reel-btns{position:relative;bottom:auto;left:auto;right:auto;justify-content:center;flex-wrap:wrap;gap:.6rem;margin-top:1.2rem;padding:0}\r
  .btn-hero-primary,.btn-outline-light{font-size:clamp(.78rem,3.5vw,.9rem);padding:.6rem 1.4rem;white-space:nowrap}\r
  .reel-dots{bottom:1.5rem;right:50%;transform:translateX(50%)}\r
\r
  /* ── Logo strip ── */\r
  #strip{padding:2rem 0}\r
  .strip-label{font-size:.82rem;margin-bottom:1.2rem}\r
  .logo-chip{font-size:.75rem;padding:.55rem .9rem;gap:.5rem;border-radius:8px}\r
  .logo-chip svg{width:18px;height:18px}\r
  .marq-wrap::before,.marq-wrap::after{width:50px}\r
\r
  /* ── Services ── */\r
  .svc-grid{grid-template-columns:1fr}\r
  .svc-card{flex-direction:column}\r
\r
  /* ── Why / Innovsol Difference ── */\r
...
\r
  ...
  .cs-card h3{font-size:.9rem}\r
\r
  /* ── FDE ── */\r
  .fde-grid,.car-grid,.con-grid,.cta-duo{grid-template-columns:1fr}\r
  .stat-cards{grid-template-columns:1fr 1fr;gap:.8rem}\r
  .stat-card .big{font-size:1.6rem}\r
  .stat-card .sm{font-size:.7rem}\r
  .fde-stages{gap:.5rem}\r
  .fde-stage{font-size:.82rem}\r
\r
  /* ── Insights ── */\r
  .ins-grid{grid-template-columns:1fr}\r
  .ins-card{padding:1.2rem}\r
\r
  /* ── Careers ── */\r
  .roles{grid-template-columns:1fr}\r
  .car-grid{grid-template-columns:1fr}\r
\r
  /* ── Hero stats ── */\r
  .hero-stats{grid-template-columns:1fr 1fr;max-width:100%}\r
  .hstat{padding:1rem .8rem}\r
  .hstat .hn{font-size:1.5rem}\r
  .hstat .hlbl{font-size:.68rem}\r
\r
  /* ── Metrics ── */\r
...
\r
  /* ── CTA ── */\r
  .cta-duo{gap:2rem}\r
  .cta-pill{font-size:.72rem;text-align:center}\r
\r
  /* ── Contact section ── */\r
  .con-hero{height:auto;min-height:560px}\r
  .con-map-content{flex-direction:column;align-items:flex-start;padding:5rem 0 2rem;gap:1.5rem}\r
  .con-panel{max-width:100%}\r
  .con-panel h2{font-size:clamp(1.5rem,6vw,2rem)}\r
  .con-hq-text{position:static;margin-top:1rem}\r
\r
  /* ── Contact form ── */\r
  .cform-hd h2{font-size:clamp(1.4rem,5.5vw,1.8rem)}\r
...
\r
  ...
  .ft-logo-link{width:200px;height:95px}\r
  .ft-logo-img{width:180px}\r
  .ft-nav{display:grid;grid-template-columns:1fr 1fr;gap:1.8rem 1.2rem;flex:none;width:100%;justify-content:flex-start}\r
  .ft-right{align-items:flex-start;width:100%;border-top:1px solid rgba(255,255,255,.1);padding-top:1.2rem}\r
  .ft-bar{flex-direction:column;align-items:flex-start;gap:.5rem}\r
}\r
\r
